...
# chnage path to use scc_streaming.jl where it is located in (orignal) MimiGIVE package locally 
include("/Users/henrywilliams/.julia/packages/MimiGIVE/7ptZI/src/utils/scc_streaming.jl")
