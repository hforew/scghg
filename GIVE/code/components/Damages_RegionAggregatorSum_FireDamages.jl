...
@defcomp Damages_RegionAggregatorSum_FireDamages begin
    ...
    damage_park_mortality = Parameter(index=[time,ag_mapping_input_regions], unit="US\$2005/yr")  # new sector
    ...
    damage_park_mortality_regions = Variable(index=[time,ag_mapping_output_regions], unit="US\$2005/yr")  # new sector
    ...
    function run_timestep(p,v,d,t)
        ...
        v.damage_park_mortality_regions[t, :] .= 0.  # new sector
        ...
        for i in d.ag_mapping_input_regions
            ...
            v.damage_park_mortality_regions[t, v.input_output_mapping_int[i]] += p.damage_park_mortality[t,i] # new sector
